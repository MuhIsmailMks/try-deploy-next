...
export const MenuButton = ({click}) => { 
    return(
        <button className='text-yellow-400 relative hidden phone:flex mobile:ml-[3vw]  '   onClick={click}> 
            <svg className='w-[30px] h-auto x-phone:w-[20px]' viewBox="0 0 55 33" fill="none" xmlns="http://www.w3.org/2000/svg">
...
export const RatingProduct = ({ratingVal}) => { 
  ...
  return (
    <div className={`stars-container ${layout.flexCenter} relative`}>  
